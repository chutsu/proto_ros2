...
# CMD="rm -rf $HOME/calib_camimu-rs0 && ros2 run proto_ros2 calib_camimu_record 0 $HOME/calib_camimu-rs1"
# CMD="ros2 run proto_ros2 calib_gimbal_record2 $HOME/calib_gimbal"
# CMD="ros2 run proto_ros2 calib_gimbal_inspect2 $HOME/calib_gimbal/calib_gimbal-results.yaml"
