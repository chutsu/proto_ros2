...
if __name__ == "__main__":
  yac_path = "/home/chutsu/projects/yac"
  calib_camera = f"{yac_path}/build/calib_camera"
  calib_camimu = f"{yac_path}/build/calib_vi"

  # calib_dir = "/home/chutsu/calib-240212"
  calib_dir = "/home/chutsu/calib-240225"
  ...
  os.system(f"{calib_camera} {calib_camera_conf} {calib_camera_rs0}")
  os.system(f"{calib_camera} {calib_camera_conf} {calib_camera_rs1}")

  # Calibrate camera-imu extrinsics
  # -- Calibrate rs0
  calib_camimu_path = create_calib_camimu_config(rs0_camera_results)
  calib_camimu_rs0 = join(calib_dir, "calib_camimu-rs0")
  os.system(f"{calib_camimu} {calib_camimu_path} {calib_camimu_rs0}")
  # -- Calibrate rs1
  calib_camimu_path = create_calib_camimu_config(rs1_camera_results)
  calib_camimu_rs1 = join(calib_dir, "calib_camimu-rs1")
  os.system(f"{calib_camimu} {calib_camimu_path} {calib_camimu_rs1}")
